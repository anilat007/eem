require(['main'],function(){
	require([ 'kbconfig', 'i18n', 'helper', 'ngRoute', 'ngAnimate', 'kbFactory'], function(kbconfig, i18n, helper) {
		i18n.loadNamespace("configReceipt", function(){
			var moduleName = window.kbSubModule.name  = "kb.module.configurations.receipt";
			var moduleViewRoot  = kbconfig.view.config.receipt;
			var moduleApi = kbconfig.api.config.receipt;
